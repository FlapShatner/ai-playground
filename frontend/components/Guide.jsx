...
function Guide({ setIsOpen, isOpen }) {
  ...
  return (
    <Modal style={customStyles} isOpen={isOpen} shouldCloseOnEsc={true} shouldCloseOnOverlayClick={true} onRequestClose={() => setIsOpen(false)}>
      <div className='flex justify-between p-4 px-8'>
        <CloseIcon onClick={() => setIsOpen(false)} className=' cursor-pointer absolute right-2 top-2' />
      ...
      <div className='flex flex-col p-8 gap-4'>
        <div className='flex flex-col gap-1'>
          ...
          <p>
            ...
            decals using a wide range of art styles. Whether you're decorating your space, personalizing items, or creating for business, Ink Monkey FonzAI is
            your go-to for artistic expression.
          </p>
        </div>
        <div className='flex flex-col gap-1'>
          <p className='text-2xl font-bold'>Getting Started</p>
          <p>
            Before you begin, ensure you're familiar with the Ink Monkey FonzAI Artificial Intelligence Design System interface. Take a moment to explore the
            various features and settings available to you.
          </p>
        </div>
        <div className='flex flex-col gap-1'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <ul className='list-disc list-inside'>
            ...
            <li className='mt-2'>
              ...
              <p className='ml-6'>
                Even though the vast majority of your “FonzAI” decal designs will come out with a black background and a white border around your art work, it
                is still a good idea to tell “FonzAI” to use something like “with a pitch black background.” at the end of your descriptive prompt.
              </p>
            </li>
            <li className='mt-2'>
              <span className='font-bold'>Adding Text: </span>
              <p className='ml-6'>
                You can add custom text to your design using a prompt like this: (Snarling Wolf, Highly Realistic Illustrative Design, Thin White border around
                image, add the text ‘Lone Wolf’ above the image, pitch black background.) Just be sure to use ‘ ‘ before and after your text.
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <p>
            As you grow more comfortable with Ink Monkey FonzAI Artificial Intelligence Design System, experiment with blending styles, adding unique elements,
            or creating thematic series. Try prompts like “A steampunk robot in a graffiti style for a laptop decal” or “A serene Japanese garden scene in
            watercolor for a window decal.”
          </p>
        </div>
        <div className='flex flex-col gap-1 '>
