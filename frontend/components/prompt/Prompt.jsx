...
import FlagMessage from './Flagged'
    ...
    useEffect(() => {
        if (lastJsonMessage) {
            ...
            if (lastJsonMessage.event === 'error') {
                if (lastJsonMessage.error.includes('community standards')) {
                    toast.warn(<FlagMessage />, { theme: 'colored', hideProgressBar: true, autoClose: false, position: 'top-left', closeOnClick: true })
