...
function LeftArrow({ className, width, color, onClick }) {
  return (
    <svg onClick={onClick} className={className} width={width} height={width} viewBox='0 0 448 512' xmlns='http://www.w3.org/2000/svg'>
      <path
